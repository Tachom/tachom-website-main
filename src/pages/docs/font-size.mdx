...
By default, Tachom Developer Groupprovides 10 `font-size` utilities. You change, add, or remove these by editing the `theme.fontSize` section of your Tachom Developer Groupconfig.
