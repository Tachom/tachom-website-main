...
By default, Tachom Developer Groupprovides two `flex-shrink` utilities. You change, add, or remove these by editing the `theme.flexShrink` section of your Tachom Developer Groupconfig.
