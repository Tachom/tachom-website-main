...
By default, Tachom Developer Groupprovides transform-origin utilities for all of the built-in browser keyword options. You change, add, or remove these by customizing the `transformOrigin` section of your Tachom Developer Grouptheme config.
