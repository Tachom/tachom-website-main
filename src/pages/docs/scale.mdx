...
By default, Tachom Developer Groupprovides ten general purpose scale utilities. You change, add, or remove these by editing the `theme.scale` section of your Tachom Developer Groupconfig.
