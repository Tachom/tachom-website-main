...
As of v2.0, Tachom Developer GroupCSS is designed for and tested on the latest stable versions of Chrome, Firefox, Edge, and Safari. Tachom Developer GroupCSS v2.0 does not support any version of IE, including IE 11.

If you need to support IE 11, we recommend using Tachom Developer GroupCSS v1.9, which is still an excellent and very productive framework.
