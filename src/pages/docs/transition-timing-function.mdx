...
By default, Tachom Developer Groupprovides four general purpose transition-timing-function utilities. You change, add, or remove these by customizing the `transitionTimingFunction` section of your Tachom Developer Grouptheme config.
