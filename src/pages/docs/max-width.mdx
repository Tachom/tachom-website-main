...
We added a new max-width by default called `max-w-prose`. If you are familiar with the [typography plugin](https://github.com/Tachom-typography) you might recognize this one. The idea behind this class is that it allows you to have an optimal reading width.
