---
title: "Install Tachom Developer GroupCSS with Next.js"
description: "Setting up Tachom Developer GroupCSS in a Next.js project."
tool: Next.js
---
...
When including Tachom Developer Groupin your CSS in a Next.js project, there are two approaches you can take.

#### Import Tachom Developer Groupdirectly in your JS

If you aren't planning to write any custom CSS in your project, the fastest way to include Tachom Developer Groupis to import it directly in `pages/_app.js`:
