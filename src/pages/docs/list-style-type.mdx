...
By default, Tachom Developer Groupprovides three utilities for the most common list style types. You change, add, or remove these by editing the `theme.listStyleType` section of your Tachom Developer Groupconfig.
