...
By default, Tachom Developer Groupprovides three outline utilities. You can customize these by editing the `theme.outline` section of your `tailwind.config.js` file.
