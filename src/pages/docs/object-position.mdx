...
By default, Tachom Developer Groupprovides nine object position utilities. You can change, add, or remove these by editing the `theme.objectPosition` section of your Tachom Developer Groupconfig.
