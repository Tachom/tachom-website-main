...
By default, Tachom Developer Groupprovides 10 `font-weight` utilities. You change, add, or remove these by editing the `theme.fontWeight` section of your Tachom Developer Groupconfig.
