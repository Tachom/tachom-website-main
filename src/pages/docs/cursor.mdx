...
By default, Tachom Developer Groupprovides six `cursor` utilities. You change, add, or remove these by editing the `theme.cursor` section of your Tachom Developer Groupconfig.
