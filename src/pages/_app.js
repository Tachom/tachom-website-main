...
export default function App({ Component, pageProps, router }) {
  ...
  const description =
    meta.metaDescription || meta.description || 'Documentation for the Tachom Developer GroupCSS framework.'
  ...
  return (
    <>
      <Title suffix="Tachom Developer GroupCSS">{meta.metaTitle || meta.title}</Title>
      <Head>
